...
Generates starting states for Conway's Game of Life that converge to whatever text you feed it, so a random-looking grid gradually resolves into readable words. Type a word and watch it happen at [conway.martinsundal.no](https://conway.martinsundal.no/).
...
[![Astro](https://img.shields.io/badge/-Astro-BC52EE?logo=astro&logoColor=white&style=flat-square)](https://astro.build/)
[![ROS2](https://img.shields.io/badge/-ROS2-22314E?logo=ros&logoColor=white&style=flat-square)](https://docs.ros.org/)
